...
declare namespace L {
    ...
    /**
      ...
      */
    function map(id: HTMLElement, options?: Map.MapOptions): L.Map;

    /**
      * Instantiates a map object given a div element id and optionally an
      * object literal with map options described below.
      */
    function map(id: string, options?: Map.MapOptions): L.Map;
    ...
    export interface MapStatic extends ClassStatic {
        /**
          ...
          * @constructor
          */
        new (id: HTMLElement, options?: Map.MapOptions): L.Map;
        ...
        /**
          ...
          * @constructor
          */
        new (id: string, options?: Map.MapOptions): L.Map;
    }
    export var Map: MapStatic;

    export interface Map extends IEventPowered<L.Map> {
        ...
        /**
          ...
          * animation options.
          */
        setView(center: LatLngExpression, zoom?: number, options?: Map.ZoomPanOptions): L.Map;

        /**
          * Sets the zoom of the map.
          */
        setZoom(zoom: number, options?: Map.ZoomPanOptions): L.Map;

        /**
          * Increases the zoom of the map by delta (1 by default).
          */
        zoomIn(delta?: number, options?: Map.ZoomPanOptions): L.Map;

        /**
          * Decreases the zoom of the map by delta (1 by default).
          */
        zoomOut(delta?: number, options?: Map.ZoomPanOptions): L.Map;
        ...
        /**
          ...
          */
        invalidateSize(options: Map.ZoomPanOptions): L.Map;

        /**
          * Checks if the map container size changed and updates the map if so — call it
          * after you've changed the map size dynamically, also animating pan by default.
          */
        invalidateSize(animate: boolean): L.Map;
        ...
        /**
          ...
          */
        setMaxBounds(bounds: LatLngBounds, options?: Map.ZoomPanOptions): L.Map;
        ...
        /**
          ...
          * details.
          */
        locate(options?: LocateOptions): L.Map;
        ...
        /**
          ...
          */
        addLayer(layer: ILayer, insertAtTheBottom?: boolean): L.Map;

        /**
          * Removes the given layer from the map.
          */
        removeLayer(layer: ILayer): L.Map;
        ...
        /**
          ...
          */
        openPopup(popup: Popup): L.Map;

        /**
          * Creates a popup with the specified options and opens it in the given point
          * on a map.
          */
        openPopup(html: string, latlng: LatLngExpression, options?: PopupOptions): L.Map;

        /**
          * Creates a popup with the specified options and opens it in the given point
          * on a map.
          */
        openPopup(el: HTMLElement, latlng: LatLngExpression, options?: PopupOptions): L.Map;

        /**
          * Closes the popup previously opened with openPopup (or the given one).
          */
        closePopup(popup?: Popup): L.Map;

        /**
          * Adds the given control to the map.
          */
        addControl(control: IControl): L.Map;

        /**
          * Removes the given control from the map.
          */
        removeControl(control: IControl): L.Map;
        ...
        /**
          ...
          */
        whenReady(fn: (map: L.Map) => void, context?: any): L.Map;
        ...
        /**
          ...
          */
        eachLayer(fn: (layer: ILayer) => void, context?: any): L.Map;

        ////////////////
        ////////////////
        addEventListener(type: string, fn: (e: LeafletEvent) => void, context?: any): L.Map;
        addOneTimeEventListener(type: string, fn: (e: LeafletEvent) => void, context?: any): L.Map;
        removeEventListener(type: string, fn?: (e: LeafletEvent) => void, context?: any): L.Map;
        hasEventListeners(type: string): boolean;
        fireEvent(type: string, data?: any): L.Map;
        on(type: string, fn: (e: LeafletEvent) => void, context?: any): L.Map;
        once(type: string, fn: (e: LeafletEvent) => void, context?: any): L.Map;
        off(type: string, fn?: (e: LeafletEvent) => void, context?: any): L.Map;
        fire(type: string, data?: any): L.Map; addEventListener(eventMap: any, context?: any): L.Map;
        removeEventListener(eventMap?: any, context?: any): L.Map;
        clearAllEventListeners(): L.Map;
        on(eventMap: any, context?: any): L.Map;
        off(eventMap?: any, context?: any): L.Map;
    }
}
...
declare namespace L {
    ...
    export interface Popup extends ILayer {
        /**
          ...
          */
        addTo(map: L.Map): Popup;

        /**
          * Adds the popup to the map and closes the previous one. The same as map.openPopup(popup).
          */
        openOn(map: L.Map): Popup;
