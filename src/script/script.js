...
var NotificationManager = (function () {
    function NotificationManager(config) {
        ...
        this.addNotificationPokemonCapture = function (pokemonCatch) {
            ...
            var eventTyp = pokemonCatch.IsSnipe ? "snipe" : "catch";
            var eventTypName = pokemonCatch.IsSnipe ?
                _this.config.translationManager.translation.eventTypes["snipe"] :
                _this.config.translationManager.translation.eventTypes["catch"];
            var html = "<div class=\"event " + eventTyp + "\">\n                        <i class=\"fa fa-times dismiss\"></i>\n                        <div class=\"image\">\n                            <img src=\"images/pokemon/" + pokemonCatch.Id + ".png\"/>\n                        </div>\n                        <div class=\"info\">\n                            " + pokemonName + "\n                            <div class=\"stats\">CP " + pokemonCatch.Cp + " | IV " + roundedPerfection + "%</div>\n                        </div>\n                        <span class=\"event-type\">" + eventTypName + "</span>\n                        <span class=\"timestamp\">0 seconds ago</span>\n                        <div class=\"category\"></div>\n                    </div>";
            var element = $(html);
            _this.addNotificationFinal({
                element: element,
                event: pokemonCatch
        ...
        this.addNotificationIncubatorStatus = function (incubatorStatus) {
            ...
            var html = "<div class=\"event incubatorStatus\">\n                        <i class=\"fa fa-times dismiss\"></i>\n                        <div class=\"image\">\n                            <img src=\"images/items/ItemEgg.png\"/>\n                        </div>\n                        <div class=\"info\">Egg\n                            <div class=\"stats\">" + km + " of " + incubatorStatus.KmToWalk + "km</div>\n                        </div>\n                        <span class=\"event-type\">" + _this.config.translationManager.translation.eventTypes["incubatorStatus"] + "</span>\n                        <span class=\"timestamp\">0 seconds ago</span>\n                        <div class=\"category\"></div>\n                    </div>";
            var element = $(html);
            _this.addNotificationFinal({
                element: element,
...
var EnglishTranslation = (function () {
    function EnglishTranslation() {
        ...
        this.itemNames = { 1: "Pokeball", 2: "Greatball", 3: "Ultraball", 4: "Masterball", 101: "Potion", 102: "Super Potion", 103: "Hyper Potion", 104: "Max Potion", 201: "Revive", 202: "Max Revive", 701: "Razzberry" };
        this.eventTypes = { "pokestop": "pokéstop", "catch": "catch", "snipe": "snipe", "evolve": "evolve", "recycle": "recycle", "transfer": "transfer", "incubatorStatus": "incubator", "eggHatched": "hatched" };
    }
...
var GermanTranslation = (function () {
    function GermanTranslation() {
        ...
        this.itemNames = { 1: "Pokéball", 2: "Superball", 3: "Hyperball", 4: "Meisterball", 101: "Tränk", 102: "Supertränk", 103: "Hypertränk", 104: "Top-Tränk", 201: "Beleber", 202: "Top Beleber", 701: "Himmihbeere" };
        this.eventTypes = { "pokestop": "pokéstop", "catch": "gefangen", "snipe": "snipe", "evolve": "Entwickelt", "recycle": "weggeworfen", "transfer": "verschickt", "incubatorStatus": "Inkubator", "eggHatched": "Geschlüpft" };
    }
